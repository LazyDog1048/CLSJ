...
//                 UiPackageItem uiPackageItem = Instantiate(PlayerPackage_Panel.Instance.uiItemOri);
...
//                     PlayerPackage_Panel.Instance.weaponDetailPanel.EnterItemPanel(packageItem);
//                     // Package_Panel.Instance.weaponDetailPanel.EnterItemPanel(packageItem);
//                     break;
//                 default:
//                     PlayerPackage_Panel.Instance.packageItemDetailPanel.EnterItemPanel(packageItem);
...
//         {
//             PlayerPackage_Panel.Instance.HidePreview();
